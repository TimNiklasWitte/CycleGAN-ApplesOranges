...
class Generator(tf.keras.Model):
    ...
    def __init__(self):
        ...
        self.down_sample_layer_stack = [
            DownSampleLayer(64, 4, apply_instance_norm=False),  # (batch_size, 128, 128, 64)
        ...
        self.metric_cycle_loss = tf.keras.metrics.Mean(name="l1_loss")
        self.metric_identity_loss = tf.keras.metrics.Mean(name="identity_loss")
